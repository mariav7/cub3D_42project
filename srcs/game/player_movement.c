...
void	go_straight(t_data *data)
{
	...
	map = data->map;
	game = data->game;
	if(ft_strchr("0NESW", map->map[(int) game->player->posY][(int) (game->player->posX + game->player->dirX * game->player->move_speed)]) != 0)
		game->player->posX += game->player->dirX * game->player->move_speed;
	if(ft_strchr("0NESW", map->map[(int) (game->player->posY + game->player->dirY * game->player->move_speed)][(int) game->player->posX]) != 0)
